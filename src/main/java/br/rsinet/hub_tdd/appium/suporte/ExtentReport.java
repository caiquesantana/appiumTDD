...
public class ExtentReport {
	...
	public static ExtentReports setExtent(String nomeReport) {
		htmlReporter = new ExtentHtmlReporter(
				"C:\\Users\\caique.oliveira\\Documents\\reports\\" + nomeReport + ".html");
	...
	public static void statusReported(ExtentTest test, WebDriver driver, String screenshotName) throws IOException {
